...
<head>
    ...
    <style type="text/css" media="screen">
        ...
        /* To make poster zoom in on hover*/
...
movie_tile_content = '''
<div class="col-md-6 col-lg-4 movie-tile text-center zoom" data-trailer-youtube-id="{trailer_youtube_url}" data-toggle="modal" data-target="#trailer">
